        ...
        <div class="row g-5">
            <div class="col-md-8">
                ...
                <nav class="blog-pagination" aria-label="Pagination">
                    <a class="btn btn-outline-danger rounded-pill px-3 {{ $post->id == $isFirst ? 'disabled' : '' }}"
                        href="{{ route('posts.show', $post->id - 1) }}">Previous</a>
                    <a class="btn btn-outline-primary rounded-pill float-end px-3 me-2 {{ $post->id == $isLast ? 'disabled' : '' }}"
                        href="{{ route('posts.show', $post->id + 1) }}">Next</a>
                </nav>
            </div>
